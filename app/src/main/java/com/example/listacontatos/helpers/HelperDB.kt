package com.example.listacontatos.helpers
...
class HelperDB (
    ...
    /*
    * Companion object: seria o mesmo que static em Java
    * pode chamá-lo sem instanciar um objeto
    *
    * */
    companion object{
    ...
    fun buscaContatos(busca: String, isBuscaPorID: Boolean = false) : List<ContatosVO>{
